...
if ($stmt -> prepare("SELECT faculty.department, count(faculty.department) * section.units FROM section
JOIN faculty ON section.instructor = faculty.instructor
WHERE deptID = 'ENGR' AND (courseNum = '1620' or courseNum = '162') AND section.semester = '1128'
